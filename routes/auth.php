...
Route::middleware('guest')->group(function () {
    ...
    Route::get('forgot-password/verify-otp', [NewPasswordController::class, 'showVerifyOtp'])
        ->name('password.verify-otp');

    Route::post('forgot-password/verify-otp', [NewPasswordController::class, 'verifyOtp'])
        ->name('password.verify-otp.submit');

    Route::post('forgot-password/resend-otp', [NewPasswordController::class, 'resendOtp'])
